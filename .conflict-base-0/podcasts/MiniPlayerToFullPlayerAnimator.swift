...
class MiniPlayerToFullPlayerAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        // Go back to simple snapshot approach - the complex layering is causing positioning issues
        let miniPlayerSnapshotView = miniPlayerView.snapshotView(afterScreenUpdates: false)
